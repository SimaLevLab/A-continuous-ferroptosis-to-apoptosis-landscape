...
#KEGG enrichment plots shown in Figure 4 and S5.
#DEG lists are created in the `1 - RNAseq analysis.R` script:
...
#------------------------------------------------------------------------------
# Venn diagram of JB2, JB3 and JB6 vs. DMSO in 24 hours (Fig. 1M, S1L)
#------------------------------------------------------------------------------
...
tiff(filename = "../results/Figure 1M - Venn of JB2, JB3, JB6 upregulated genes in MDA468.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure S1L - Venn of JB2, JB3, JB6 upregulated genes in HCC70.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure S1L - Venn of JB2, JB3, JB6 downregulated genes in MDA468.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure S1L - Venn of JB2, JB3, JB6 downregulated genes in HCC70.tiff", width = 800, height = 800)
...
ggsave("../results/Figure 5A - KEGG enrichment of JB2, JB3, JB6 common genes.tiff", dpi = 300, height = 5, width = 8)

#------------------------------------------------------------------------------
# KEGG enrichment of JB2 vs. JB6 in 24 hours (Fig. 5B, C, S5)
#------------------------------------------------------------------------------
...
ggsave("../results/Figure 5B - KEGG enrichment of JB2 vs JB6 genes.tiff", dpi = 300, height = 5, width = 8)
...
ggsave("../results/Figure 5C - KEGG enrichment of JB6 vs JB2 genes.tiff", dpi = 300, height = 5, width = 8)

#KEGG enrichment plot for HCC70 (Fig. S6A)
...
ggsave("../results/Figure S6A - KEGG enrichment of JB2 vs JB6 genes in HCC70.tiff", dpi = 300, height = 5, width = 14)

#-------------------------------------------------------------------------------
# Venn diagrams for unregulated JB2 exclusive genes (genes upregulated only by JB2, not J or B2)
# Venns for MDA468 are shown in the manuscript (Fig. 5D-G)
...
tiff(filename = "../results/Figure 5D - Venn of JB2 exclusive genes in MDA468.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure 5F - Venn of JB3 exclusive genes in MDA468.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure 5G - Venn of JB6 exclusive genes in MDA468.tiff", width = 800, height = 800)
...
# Venns for MDA468 are shown in the manuscript (Fig. S6B)
# Venns for HCC70 are not shown, but are prepared and used in KEGG enrichment
#-------------------------------------------------------------------------------
...
tiff(filename = "../results/Figure S6B - Venn of JB2 exclusive downregulated genes in MDA468.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure S6B - Venn of JB3 exclusive downregulated genes in MDA468.tiff", width = 800, height = 800)
...
tiff(filename = "../results/Figure S6B - Venn of JB6 exclusive downregulated genes in MDA468.tiff", width = 800, height = 800)
...
#-------------------------------------------------------------------------------
# Venn diagram of the JB2 exclusive genes (24h) in both cell lines (Fig. S6C)
#-------------------------------------------------------------------------------
...
tiff(filename = "../results/Figure S6C - JB2 exclusive genes in both cell lines.tiff", width = 800, height = 800)
plot(euler(Venn_SynGenes_list), quantities = list(cex = 5), lty = 1, lwd = 2, labels = FALSE,
     fill = c(colJB2, colJB2_H70))
dev.off()

#-------------------------------------------------------------------------------
# KEGG enrichment plot for JB2 exclusive genes in 24h (Fig. 5E)
#-------------------------------------------------------------------------------
...
ggsave("../results/Figure 5E - KEGG enrichment of JB2 exclusive genes.tiff", dpi = 300, height = 5.5, width = 7)
...
#-------------------------------------------------------------------------------
# KEGG enrichment of the JB2 upregulated exclusive genes in 6h 
...
ggsave("../results/Figure not shown - KEGG enrichment of JB2 exclusive genes in 6h.tiff", dpi = 300, height = 5, width = 10)

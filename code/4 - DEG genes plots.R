#create the genes bar graphs (Figure S2G, 2G, 3G)
...
#-------------------------------------------------------------------------------------------
# Ferroptosis related JB2 exclusive genes (Fig. 2F)
#-------------------------------------------------------------------------------------------
...
ggsave("../results/Figure S2G - List of JB2 exclusive genes.tiff", dpi = 300, height = 8, width = 20)

#-------------------------------------------------------------------------------------------
# Lysosomal genes in JB2 (Fig. 2G)
#-------------------------------------------------------------------------------------------
...
ggsave("../results/Figure 2G - List of lysosome related genes.tiff", dpi = 300, height = 9, width = 12)

#-------------------------------------------------------------------------------------------
# ATF4-only targets (Figure 3G)
#-------------------------------------------------------------------------------------------
...
ggarrange(p1, p2, align = "hv")
ggsave("../results/Figure 3G - List of ATF4 target genes.tiff", dpi = 300, height = 8, width = 12)

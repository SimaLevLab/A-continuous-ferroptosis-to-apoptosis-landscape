...
#PCA plot - for MDA468 cells (Fig. 1K)
...
p
ggsave("../results/Figure 1K - PCA plot.tiff", dpi = 200, height = 6, width = 6)

#Measure distance in PCA (Fig. S1K)
...
ggsave("../results/Figure S1K - Distances in PCA plot.tiff", dpi = 300, height = 4, width = 2.5)

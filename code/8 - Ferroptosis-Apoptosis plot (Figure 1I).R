#This script will create Figure 1I, showing the JB2-JB3-JB6 transcriptomics on a ferroptosis-apoptosis plane.
#NOTE: in the original code we did not set a random seed, therefore the figure might look slightly different compared to 
#the published version. This will be fixed before publication.
...
ggsave("../results/Figure 1H - transcriptomic landscape of the combinations based on TNBC RCD axes.tiff", dpi = 200, width = 6, height = 6)

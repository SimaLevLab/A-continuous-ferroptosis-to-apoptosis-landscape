#This script will create the plots of the Gradient Gene Set (Fig. 5A, B)
...
ggsave("../results/Figure 5A - GGS representative genes.tiff", dpi = 300, height = 2, width = 4)

#plot the GGS scatter plots for MDA468 (Fig. 5B)
gradient <- DEG_24h %>% 
...
ggsave("../results/Figure 5B - Volcano plot of GGS genes in MDA468.tiff", dpi = 300, height = 6, width = 6)
...
ggsave("../results/Figure S6A - Volcano plot of GGS genes in HCC70.tiff", dpi = 300, height = 6, width = 6)

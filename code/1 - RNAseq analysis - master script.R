...
#The main script takes the count matrix as input, and calculates the differential expressed genes
#Further, this script will create the Gradient Gene Signature (GGS), needed for figure 2.
...
# After this filtration, the genes are sorted by their gradient value (JB6 to JB2 fold change),
